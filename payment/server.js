...
const MERCHANT_MERCHANTURL = process.env.MERCHANT_MERCHANTURL || 'https://meredith-production.up.railway.app/redsys-notification';
...
async function sendFacebookConversionEvent(donationRow) {
    try {
        ...
        const eventSourceUrl = 'https://mereditme.space/thanks.html'; // Adjust if necessary
